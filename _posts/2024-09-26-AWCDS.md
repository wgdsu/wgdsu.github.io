...
We have also used the AWCDS as an opportunity to practically test our solution to automating the production of high quality, accessible charts that conform to Welsh Government guidance for external publications. To do this we use [KASStylesR](https://github.com/wgdsu/KASStylesR), an R package we developed as a ggplot2 theme wrapper. The package is available for you to modify to your organisation standards here.
