...
Table One: Number of reports generated for the AWCDS
...
Figure 1: Examples of a report JSON 
...
We have also used the AWCDS as an opportunity to practically test our solution to automating the production of high quality, accessible charts that conform to Welsh Government guidance for external publications. To do this we use KASStylesR, an R package we developed as a ggplot2 theme wrapper. The package is available for you to modify to your organisation standards here.

Figure 2: Example of charts formatted by KASStylesR
...
Instead of creating multiple different main.R files to generate different repots, we define these parameters in the central main.josn file.
